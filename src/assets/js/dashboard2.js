$(function() {
    ...
    var options = {
        color: "#adb5bd",
        series: [250, 200, 200],
        labels: ["Current Month", "Previous Month", "Previous Year"],
        chart: {
            type: "donut",
            fontFamily: "Plus Jakarta Sans', sans-serif",
            foreColor: "#adb0bb",
        ...
        colors: ["var(--bs-danger)", "var(--bs-success)", "var(--bs-warning)"],
    ...
    if(document.querySelector("#monthly-earning"))
    ...
    if(document.querySelector("#weekly-stats"))
    ...
    if(document.querySelector("#table-chart"))
    ...
    if(document.querySelector("#table-chart-1"))
    ...
    if(document.querySelector("#table-chart-2"))
    ...
    if(document.querySelector("#table-chart-3")){
    ...
    if(document.querySelector("#expense")) {
    ...
    if(document.querySelector("#sales-two")) {
